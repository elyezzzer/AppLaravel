    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex items-end justify-between mb-7 flex-wrap gap-4">
            ...
            <a href="{{ route('acessorios.create') }}"
               class="inline-flex items-center gap-1.5 px-4 py-2 bg-gray-900 text-white text-xs font-medium rounded-lg hover:bg-gray-700 transition-colors duration-150">
